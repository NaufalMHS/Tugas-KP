...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Halaman Tambah Data Keluar Backdate
        </div>



        <div class="card-body md-3">
            <form method="post" action="<?= base_url('suratkeluar/proses_keluar'); ?>" enctype="multipart/form-data">
