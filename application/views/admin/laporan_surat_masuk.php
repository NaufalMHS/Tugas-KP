...
<div class="row">
    ...
    <div class="col-lg-7" id="tanggalfilter">
        <div class="card">
            ...
            <form action="<?php echo base_url(); ?>suratmasuk/filter" method="POST" target="_blank">
    ...
    <div class="col-lg-7" id="bulanfilter">
        <div class="card">
            ...
            <form id="formbulan" action="<?php echo base_url(); ?>suratmasuk/filter" method="POST" target="_blank">
                <div class="card-body card-block">
    ...
    <div class="col-lg-7" id="tahunfilter">
        <div class="card">
            ...
            <form id="formtahun" action="<?php echo base_url(); ?>suratmasuk/filter" method="POST" target="_blank">
                <input name="valnilai" type="hidden">
                <div class="card-body card-block">
