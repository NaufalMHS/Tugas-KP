<div class="container-fluid">
    <div class="card">
        <h5 class="card-header">Detail Surat Respon</h5>
        <div class="card-body">
            <?php foreach ($detail_surat_respon as $dsk) : ?>
                ...
                <div class="col-md-8 col-sm-12">
                    <table class="table">
                        <tr>
                            ...
                            <td><strong><?= $dsk->no_surat_masuk ?></strong></td>
                        </tr>
                        <tr>
                            <td>Nomor Surat Respon</td>
                            <td><strong><?= $dsk->nomor_surat_respon ?></strong></td>
                        </tr>
                        <tr>
                            <td>Jenis Surat</td>
                        ...
                        <tr>
                            <td>Tanggal Surat</td>
                            <td><strong><?= $dsk->tanggal_surat_respon ?></strong></td>
                        </tr>
                        <tr>
                            <td>Jabatan</td>
                            <td><strong><?= $dsk->jabatan_surat_respon ?></strong></td>
                        </tr>
                        <tr>
                            <td>Tujuan Surat</td>
                            <td><strong><?= $dsk->tujuan_surat_respon ?></strong></td>
                        </tr>
                    ...
                    <a href=" <?php echo base_url('suratrespon'); ?>"
                        class="btn btn-primary btn-sm float-right">kembali</a>
                    <?php if ($dsk->approve != 'approve') { ?>
                    <?php if ($dsk->approve != 'tolak') { ?>
                    <a href=" <?php echo base_url('suratrespon/setuju/' . $id); ?>"
                        class="btn btn-primary btn-sm float-left mx-2">Approve</a>

                    <a href=" <?php echo base_url('suratrespon/tolak/' . $id); ?>"
