...
var myPieChart = new Chart(ctx, {
    type: "doughnut",
    data: {
        labels: ["SURAT MASUK", "SURAT KELUAR", "SURAT RESPON"],
        datasets: [{
            data: [<?= $total_masuk ?>, <?= $total_keluar ?>, <?= $total_respon ?>],
...
<script src="<?= base_url(); ?>assets/js/swalert/sweetalert2.all.min.js"></script>
